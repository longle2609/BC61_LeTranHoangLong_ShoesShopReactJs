...
const Ex_Binding = () => {
  ...
  // Được phép truyền các giá trị là mảng chứa số hoặc chuỗi lên giao diện để hiển thị,
  let sinhVien = {
    hoTen: "Trần Lâm",
    namSinh: 2000,
  };
  ...
  // let soDiem = [1, 5, 8, 2, 9, <div>Hello</div>, { hoTen: "Nam" }];
  ...
  return (
    <div>
      ...
      <div>
        ...
        {/* Lưu ý khi sử dụng hình ảnh thông qua đường dẫn tĩnh: vị trí bắt đầu đường dẫn tính từ file html và chỉ đi được tới các thư mục bên ngoài, không truy cập vào thư mục src  */}
        <img src="./public/luffy.jpeg" alt="" />
      </div>
